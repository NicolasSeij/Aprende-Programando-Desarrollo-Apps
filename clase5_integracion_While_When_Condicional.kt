    ...
    while (opcionElegida != 0) {
        when (opcionElegida) {
            1 -> {
                ...
                println("")
                println("Las variables, en todos los lenguajes de programación, son espacios reservados en memoria. " +
                        "Pueden ser de distinto tipo: Int, String, Double, Float, Boolean, Char.")
                opcionElegida = 0
            }
            2 -> {
            ...
            4 -> {
                ...
                println("")
                println("Son estructuras de control que permiten la bifurcación del código \n" +
